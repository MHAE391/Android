        ...
        findViewById(R.id.RegisterButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Validation.PasswordValidation(password).equals("Empty") || Validation.EmailValidation(email).equals("Empty")
                    ...
                    Toast.makeText(RegisterNewAdmin.this,"Please Fill Inputs",Toast.LENGTH_SHORT).show();
                }else {

                    if(Validation.EmailValidation(email).equals("Format Error")){
                        Toast.makeText(RegisterNewAdmin.this,"Email Must Be Like This Format : " +
                                "\n         Example@Test.com",Toast.LENGTH_SHORT).show();
                    }
                    else if(Validation.EmailValidation(email).equals("Starting Error")){
                        Toast.makeText(RegisterNewAdmin.this,"Email Must Start With Character",Toast.LENGTH_SHORT).show();
                    }

                    else if(Validation.PasswordValidation(password).equals("Small Password")){
                        Toast.makeText(RegisterNewAdmin.this,"Password Must Be 4 Numbers Or More",Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(RegisterNewAdmin.this,"Name Must Be 3 Characters Or More " +
                        ...
                        Toast.makeText(RegisterNewAdmin.this, "Name Must Include One Character At Least", Toast.LENGTH_SHORT).show();
                    } else if(Validation.NameValidation(firstName).equals("Find Space")||Validation.NameValidation(lastName).equals("Find Space")) {
                        Toast.makeText(RegisterNewAdmin.this, "Name Include Spaces", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(RegisterNewAdmin.this, "Name Include Special Character", Toast.LENGTH_SHORT).show();
                    }else if(Validation.AgeValidation(age).equals("Wrong Start")) {
                        Toast.makeText(RegisterNewAdmin.this, "Not Acceptable Age", Toast.LENGTH_SHORT).show();
                    }else if(Validation.AgeValidation(age).equals("Not Acceptable Age")) {
                        Toast.makeText(RegisterNewAdmin.this, "Age Must Be 18 Or More " +
                        ...
                        Toast.makeText(RegisterNewAdmin.this, "Phone Must Start With 01", Toast.LENGTH_SHORT).show();
                    }else if(Validation.PhoneValidation(phone).equals("Not Acceptable Phone")) {
                        Toast.makeText(RegisterNewAdmin.this, "Phone Must Be 11 Number", Toast.LENGTH_SHORT).show();
                    }else if(!password.equals(rePassword)) {
                        Toast.makeText(RegisterNewAdmin.this, "Password And Confirm Password Does Not Match", Toast.LENGTH_SHORT).show();
                    } else{
                        DataBase x=new DataBase(RegisterNewAdmin.this);
                        if(x.Check(email.toString()).equals("User")){
                            Toast.makeText(RegisterNewAdmin.this, email+"\nIs Already A User", Toast.LENGTH_SHORT).show();
                        } else {
                            String Done=x.Insert(firstName+" "+lastName,email,password,phone,Integer.parseInt(age),1);

                            if(Done.equals("DONE")) {
                                Toast.makeText(RegisterNewAdmin.this, "Account Created", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(RegisterNewAdmin.this,AdminUi.class));
                            }else{
                                Toast.makeText(RegisterNewAdmin.this, "Can't Create Account", Toast.LENGTH_SHORT).show();
                            }                }
                    }
                }
            }
