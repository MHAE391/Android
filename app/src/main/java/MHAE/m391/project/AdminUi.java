...
public class AdminUi extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().replace(R.id.FragmentUserUi,
                    new AdminUiHomeFragment()).commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case  R.id.profile:
                ...
                break;
            case  R.id.logout:
                startActivity(new Intent(AdminUi.this,MainActivity.class));
                finish();
                break;
            case R.id.callus:
                getSupportFragmentManager().beginTransaction().replace(R.id.FragmentUserUi,
